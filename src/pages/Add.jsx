    ...
    <>
      {
        ...
        showspin ?
          ...
          <div className='container mt-3'>
            ...
            <h3 className='text-center fw-bolder'>Add New Student Details</h3>

            <div className='mt-3 shadow border rounded p-3'>

              <div className='text-center'>
                <img style={{ width: '70px', height: '70px', borderRadius: '50%' }} src={preview ? preview : "https://static.vecteezy.com/system/resources/thumbnails/019/900/322/small/happy-young-cute-illustration-face-profile-png.png"} alt="No Img" />
              </div>
              ...
              <Form className='mt-5'>
                ...
                <Row>
                  ...
                  <Form.Group className='mb-3 col-lg-6 mt-3'>
                    ...
                    {/* Male */}
                    <Form.Check type={"radio"} value={"Male"} label={"Male"} name='gender' onChange={e => getandsetNormalInputs(e)} />

                    {/* Female */}
                    <Form.Check type={"radio"} value={"Female"} label={"Female"} name='gender' onChange={e => getandsetNormalInputs(e)} />
